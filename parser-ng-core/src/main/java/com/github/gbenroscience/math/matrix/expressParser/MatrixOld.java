...
public class MatrixOld {
    ...
    /**
     * The simple name used to label this MatrixOld object.
     *
     */
    private String name;
    /**
     * the data array used to create this MatrixOld object
     */
    private double array[][];

    /**
     *
     * @param rows The number of row in the MatrixOld.
     * @param cols The number of columns in the MatrixOld.
     */
     ...
     * this MatrixOld object.
     *
     * Assigns name unknown to the MatrixOld object and a 2D array that has just a
     * row and a column
     *
     */
    ...
    /**
     *
     * @param array the data array used to create this MatrixOld object
     */
    ...
    /**
     *
     * @param matrix constructs a new MatrixOld object having similar properties to
    ...
    public MatrixOld(MatrixOld matrix) {
        ...
        /* Copy the array of the MatrixOld object parameter into
         * a separate array object and use for the
         * MatrixOld object about to be created.
         * This ensures that the new MatrixOld object
     ...
     * this + matrice )
     * @return a MatrixOld containing the product matrix.
     */
     ...
     * @return a new MatrixOld object containing the product matrix of the
     * operation matrice1 X matrice2
     */
    public static MatrixOld multiply(MatrixOld matrice1, MatrixOld matrice2) {

        MatrixOld m = new MatrixOld(matrice1.getRows(), matrice2.getCols());
    ...
    public void multiply(MatrixOld matrice) {
        setArray(MatrixOld.multiply(this, matrice).array);
    }
    ...
    public static MatrixOld pow(MatrixOld mat, int pow) {
        MatrixOld m = new MatrixOld(mat.array);
        for (int i = 0; i < pow - 1; i++) {
            m = MatrixOld.multiply(m, mat);
    ...
    public static MatrixOld power(MatrixOld mat, int pow) {
        ...
        switch (pow) {
            case 0:
                return unitMatrixOld(mat.getRows(), mat.getCols());
            case 1:
                return mat;
            default:
                /**
    ...
    /**
     *
     * @param mat the MatrixOld object that we wish to construct a unit matrix of
    ...
    /**
     * Place the first MatrixOld object side by side with the second one passed as
     ...
     *
     *
     * @param mat1 the first MatrixOld object
     * @param mat2 the second MatrixOld object that we column join with this one
     * @return a new MatrixOld object that contains this MatrixOld object placed side
     * by side with the MatrixOld object passed as argument.
     */
    public static MatrixOld columnJoin(MatrixOld mat1, MatrixOld mat2) {

        MatrixOld join = new MatrixOld(mat1.getRows(), mat1.getCols() + mat2.getCols());
     ...
     *
     * @param mat1 the first MatrixOld object
     * @param mat2 the second MatrixOld object that we row join with this one
     * @return a new MatrixOld object that contains the first MatrixOld object
     * argument placed top to bottom with the second MatrixOld object argument.
     */
    public static MatrixOld rowJoin(MatrixOld mat1, MatrixOld mat2) {

        MatrixOld join = new MatrixOld(mat1.getRows() + mat2.getRows(), mat1.getCols());
    ...
    /**
     * Deletes all the specified number of columns from the MatrixOld object
     * starting from the end of the MatrixOld object
     *
     * @param column the number of columns to remove from the MatrixOld object.
     * This method will take the object that calls it and perform this operation
     * on it. So it modifies the MatrixOld object that calls it. Be careful, as
     * data will be lost.
     *
    ...
    public void columnDeleteFromEnd(int column) {
        if (column >= 0 && column <= getCols()) {
            MatrixOld matrix = new MatrixOld(this.getRows(), this.getCols() - column);
            for (int row = 0; row < getRows(); row++) {
                for (int col = 0; col < matrix.getCols(); col++) {
    ...
    /**
     * Deletes all the specified number of columns from the MatrixOld object from
     * the beginning of the MatrixOld object
     *
     * @param column the number of columns to remove from the MatrixOld object's
     * beginning. This method will take the object that calls it and perform
     * this operation on it. So it modifies the MatrixOld object that calls it. Be
     ...
     *
     * @param numOfRows the number of row to remove from the MatrixOld object's
     * beginning. This method will take the object that calls it and perform
     * this operation on it. So it modifies the MatrixOld object that calls it. Be
     * careful, as data will be lost.
     *
    ...
    public void rowDeleteFromEnd(int numOfRows) {
        if (numOfRows >= 0 && numOfRows <= getRows()) {
            MatrixOld matrix = new MatrixOld(this.getRows() - numOfRows, this.getCols());
            for (int row = 0; row < matrix.getRows(); row++) {
    ...
    /**
     * Deletes the specified number of row from the beginning of the MatrixOld
     * object
     *
     * @param numOfRows the number of row to remove from the MatrixOld object's
     * beginning. This method will take the object that calls it and perform
    ...
    public MatrixOld reduceToTriangularMatrixOld() {
        ...
        MatrixOld mat = new MatrixOld(this);
        //Now we row-reduce.
    ...
    /**
     * Used to solve a system of simultaneous equations placed in this MatrixOld
     * object.
     *
     * @return a MatrixOld object containing the solution matrix.
     */
    public MatrixOld solveEquation() {
        return MatrixOld.solveEquation(this);
    }//end method solnMatrixOld

    /**
     * Used to solve a system of simultaneous equations placed in the MatrixOld
     * object.
     *
    ...
    public static MatrixOld solveEquation(MatrixOld matrix) {
        MatrixOld solnMatrixOld = new MatrixOld(matrix.getRows(), 1);

        MatrixOld matrixLoader = matrix.reduceToTriangularMatrixOld();
            ...
            for (int row = matrixLoader.getRows() - 1; row >= 0; row--) {
                for (int col = row + 1; col < matrixLoader.getCols(); col++) {
                    ...
                    if (col < matrixLoader.getCols() - 1) {
                        sum += (matrixLoader.array[row][col] * solnMatrixOld.array[col][0]);//sum the product of each coefficient and its unknown's value in the solution matrix
                ...
                solnMatrixOld.array[matrixLoader.getRows() - counter][0] = sum / matrixLoader.array[row][row];
        ...
        return solnMatrixOld;
    }//end method solnMatrixOld

    /**
     *
     * @return the transpose of this MatrixOld object. Does not modify this matrix
     * object but generates the transpose of this MatrixOld object as another
     * MatrixOld object.
     */
    ...
    public MatrixOld adjoint() {
        if (isSquareMatrixOld()) {
            ...
            return new MatrixOld(matrix).transpose();
        }
        return null;
    }
    ...
    /**
     *
     * @return true if this MatrixOld object is a square matrix.
     */
    ...
    /**
     *
     * @return true if this MatrixOld object can represent a system of equations
     ...
     */
    private static double $2X2determinant(MatrixOld m) {
     ...
     */
    private static MatrixOld topRowScalarMultiply(MatrixOld m, double scalar) {
        for (int col = 0; col < m.getCols(); col++) {
            m.array[0][col] *= scalar;
        }
        return new MatrixOld(m.array);
    }
     ...
     * O(n!)
     *
     * @param m the MatrixOld object whose detMultiplier is desired.
     * @return the detMultiplier of the matrix
     */
    private static final double det(MatrixOld m, double acc) {
        ...
        if (m.getRows() == m.getCols()) {
            if (m.getRows() == 2) {
                ...
                for (int col = 0; col < m.getCols(); col++) {
                    ...
                    MatrixOld mat = topRowScalarMultiply(m.minor(0, col), topRow);
    ...
    /**
     *
     * @param row The row in this MatrixOld object to be converted into a new
     * MatrixOld object. This operation generates a new MatrixOld object which is a
     * row matrix.
     */
    public MatrixOld getRowMatrixOld(int row) {
        ...
        return new MatrixOld(arr);
    }

    /**
     *
     * @param column The column to be converted into a new MatrixOld object. This
     * operation generates a new MatrixOld object which is a column matrix.
     */
    ...
    /**
     * Computes the inverse of this MatrixOld object. This technique should never
     ...
     *
     * @return the inverse of the MatrixOld as another MatrixOld object.
     */
    public MatrixOld oldInverse() {

        MatrixOld m = new MatrixOld(this);
        MatrixOld unit = m.unitMatrixOld();
        MatrixOld inverse = new MatrixOld(new double[m.getRows()][m.getCols()]);
        if (m.isSquareMatrixOld()) {
            for (int rows = 0; rows < m.getCols(); rows++) {
                MatrixOld c = MatrixOld.columnJoin(m, unit.getColumnMatrixOld(rows));
                inverse = MatrixOld.columnJoin(inverse, c.solveEquation());
            }//end for
        }//end if
    ...
    public MatrixOld inverse() {
        ...
        if (m.isSquareMatrixOld()) {
            MatrixOld unit = m.unitMatrixOld();
            MatrixOld inverse = MatrixOld.columnJoin(this, unit);
     ...
     */
    private MatrixOld getCofactor(int rw, int cl) {
        if (rw >= 0 && cl >= 0) {

            int rows = getRows();
            int cols = getCols();

            MatrixOld mat = new MatrixOld(rows - 1, cols - 1);
    ...
    public static void main(String... args) {
        ...
        MatrixOld ma = new MatrixOld(array1);

        System.out.println("MatrixOld...");
        ma.print();

        MatrixOld cof = ma.getCofactorMatrixOld();

        System.out.println("Cofactor MatrixOld...");
        cof.print();

        String eqn = MatrixOld.findCharacteristicPolynomialForEigenValues(ma);
        ...
        MatrixOld b = new MatrixOld(arr1);
        ...
        MatrixOld c = new MatrixOld(arr2);

        System.out.println("eigen-eqn-c: " + findCharacteristicPolynomialForEigenValues(c));

        MatrixOld m1 = new MatrixOld(4, 4);
        double array[][] = {{1, -8, 2, 5}, {4, 8, 2, 4}, {6, 5, 2, 1}, {2, 1, 6, 8}};
        m1.array = array;
        System.out.printf("MatrixOld: %s\nDeterminant:\n %f\n", m1.toString(), det(m1, 0));
        MatrixOld triMatrixOld = m1.reduceToRowEchelonMatrixOld();

        System.out.printf("Echelon-matrix of above: %s\n", triMatrixOld.toString());

        int rows = 11;
        int cols = 11;
        MatrixOld m = new MatrixOld(rows, cols);
        m.randomFill(20);
        ...
        /*
        MatrixOld m1 = new MatrixOld( new double[][]{{5, -6, 8, 9}, {3,1,0,6}, {2,10,4,5}, {16,12,2,4}});

        System.out.println("--------------------------MatrixOld:\n" + m1);
        System.out.println("Inverse: " + m1.inverse());

        MatrixOld m2 = new MatrixOld(2, 2);
        m2.randomFill(20);

        MatrixOld m3 = new MatrixOld(m2);
        System.out.println("OLD INVERSE METHOD ");

        System.out.println("NEW MATRIX: " + m2);

        MatrixOld m4 = m2.oldInverse();
        System.out.println("INVERSE: " + m4);

        System.out.println("Product using old method: M X 1/M: " + MatrixOld.multiply(m2, m4));

        System.out.println("NEW INVERSE METHOD ");

        System.out.println("NEW MATRIX: " + m3);

        MatrixOld m5 = m3.inverse();
        System.out.println("INVERSE: " + m5);

        System.out.println("Product using new method: M X 1/M: " + MatrixOld.multiply(m3, m5));*/
        /**
         * double t0 = System.nanoTime(); MatrixOld m = new MatrixOld(3024,3025);
         ...
         * //System.out.print( m );
         *
         * t0 = System.nanoTime(); MatrixOld soln = m.solveEquation(); t1 =
         * System.nanoTime() - t0; System.out.print( "Solved the matrix in "+
         * (t1 * 1.0E-6)+" ms" ); //System.out.print( soln );
         *
         * //MatrixOld a = new
         * MatrixOldValueParser("[2,4,5:3,9.939,45.2:1,4,2:]").getMatrixOld();
         * //MatrixOld b = new
         * MatrixOldValueParser("[-2,-4,-5:-3,-9.939,-45.2:-1,-4,-2:]").getMatrixOld();
         *
         * //System.out.print( MatrixOld.pow(a, 5) );
         */
    }
