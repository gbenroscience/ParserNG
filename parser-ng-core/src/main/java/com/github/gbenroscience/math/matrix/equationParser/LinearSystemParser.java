...
public class LinearSystemParser {
    ...
    private ArrayList<String> unknowns = new ArrayList<>();//A list of the unknowns
...
//This is the sngle character string that must end each line of equation.
    ...
    public LinearSystemParser(String systemOfEquations) {
         ...
         * variable token.
         *
         * for(int i=0;i<scanner.size();i++){ try{
         ...
         * MmathScanner scan=new MmathScanner(scanner.get(i)); ArrayList<String>
         * split=scan.splitStringAtFirstNumber(scanner.get(i)); if( validNumber(
         * split.get(0) )&&isVariableString(split.get(1)) ){ scanner.remove(i);
         * scanner.addAll(i, split); i+=2; } }
         *
         * }
...
-2.3E-2x-2.09y+3.01E-2z=1.39:
    ...
    /**
     * Counts the number of unknowns in the system and compares it with the
     * number of equations in the system. They must be equal and so it carries
     * out this validation also.
     *
     * This method also fills the ArrayList object that records the unknowns in
     * the system with one copy of each unknown found in the system.
     */
...
//validate
    ...
    /**
     * Checks the left and right of all variables to see if the appropriate
     * items are the ones there. It is a syntax error if an invalid item is
     * found there
     */
    ...
    /**
     * Checks the left and right of an operator to see if the appropriate items
     * are the ones there. It is a syntax error if an invalid item is found
     * there
     */
     ...
     *
     * e.g 2x+3y+4z+7x-9=3x-8y+2; 4z-2x-9=3x-8y+2z+9; -9x+5y+x=9x-2y+2;
     *
     * is converted into
     *
     * 6x+11y+4z=11; -5x+8y+2z=18; -17x+7y=2;
     *
     */
...
//detect the coefficients that occur at the beginning of each line.
    ...
    /**
     * Builds the Matrix object that will contain the executable generated by
     * this LinearSystemParser object.
     */
    ...
    /**
     * This builds the ideal form of the system with 0 coefficients assigned to
     * parts of the system where an unknown is missing...e.g in 2x+3y+4z=9;
     * 7x+5z=8; 6y=9;
     *
     * This system will eventually be converted into 2x+3y+4z=9; 7x+0y+5z=8;
     * 0x+6y+0z=9;
     *
     */
