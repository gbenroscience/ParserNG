...
public final class CudaBindings {
    ...
    public final MethodHandle cuDeviceGetName;
    ...
    public CudaBindings() {
        ...
        // added for CudaDeviceSelector.listAvailableDevices(); not used by
        // the interpreter kernel dispatch path itself.
        cuDeviceGetName = downcall("cuDeviceGetName", FunctionDescriptor.of(CI, PTR, CI, CI));
