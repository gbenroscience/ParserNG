...
// Hyperbolic Inverses
        ...
        // =========================================================================
        /**
         * Lean, array-only ADD — identical in shape (4 branches, plain
         * {@code DoubleVector.fromArray}, no segment fields touched) to the
         * pre-MemorySegment[]-feature implementation. Used whenever this
