 ...
 * @author GBEMIRO
 */
public class SIMDCommandF64Test {
    ...
    public void testMathematicalPrecisionVsNativeJavaFlat() throws Throwable {
        ...
        SIMDCommandF64.SIMDVectorCompositeExpression evaluator = (SIMDCommandF64.SIMDVectorCompositeExpression) new SIMDCommandF64(me).compile();
 ...
 @ParameterizedTest(name = "GeLU Matrix Size: {0}x{0}")
    ...
    private void executeKernelBenchmark(String kernelName, int sz, int arity) throws Throwable {
        ...
        SIMDCompositeExpression evaluator = (SIMDCompositeExpression) new SIMDCommandF64(me).compile();
