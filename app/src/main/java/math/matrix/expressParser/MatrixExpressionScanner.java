...
for(int i=0;i<scanner.size();i++){
    ...
    if(!isMatrixVariableName(scanner.get(i))&&!Variable.isVariableString(scanner.get(i))&&!Operator.isOperatorString(scanner.get(i))&&!expressParser.Number.isNumber(scanner.get(i))){
