...
public class Number {
    ...
    * output of the parent MathExpression object that contains this Number object.
    */
   private int index;
 ...
 /**
     *
     * @param num The string of digits that represent this Number object.
     * @param index the location of this Operator object in its parent MathExpression
...
/**
 *
 * @param index sets the location of this Operator object in its parent MathExpression
 */
...
else if(num.length()>1&&( firstElement(num).equals(Operator.PLUS)||firstElement(num).equals(Operator.MINUS) ) ){
...
else if(firstElement(num).equals(Operator.PLUS)||firstElement(num).equals(Operator.MINUS)){
    if(num.length() > 1){
        if(isDigit(num.substring(1,2))||num.substring(1,2).equals(".")){
            verily=true;
        }
