...
![Latest Version](https://img.shields.io/badge/version-3.0.7-success)

> **3.0.7** introduces **Turbo Scalar** and **Turbo Matrix** compiled paths + massive speed improvements via strength reduction, constant folding, and O(1) frame-based argument passing.
...
https://central.sonatype.com/artifact/com.github.gbenroscience/parser-ng/3.0.7
...
```bash
java -jar parser-ng-3.0.7.jar "sin(x) + cos(x)"
java -jar parser-ng-3.0.7.jar "eigvalues(R=@(5,5)(...))"
java -jar parser-ng-3.0.7.jar help
java -jar parser-ng-3.0.7.jar -i          # interactive mode
```
...
- [LATEST.md](LATEST.md) — what’s new in 3.0.7
- Javadoc: https://javadoc.io/doc/com.github.gbenroscience/parser-ng/3.0.7
...
**ParserNG 3.0.7** — faster than the competition, stronger on matrices, and now with real Turbo Scalar + Turbo Matrix compiled power.
