 ...
 * {@code IS}, {@code NULL}, {@code TRUE}, {@code FALSE}) are matched
 * case-insensitively, exactly like standard SQL; everything else
 * (identifiers, i.e. column/table/function names) is case-sensitive, since
 * those names are looked up verbatim against Arrow column names and
 * ParserNG's own case-sensitive function/variable names downstream.
 *
 * @author GBEMIRO
 */
