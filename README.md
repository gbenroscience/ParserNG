...
![Latest Version](https://img.shields.io/badge/version-1.1.5-success)

> **1.1.5** introduces **Turbo Scalar** and **Turbo Matrix** compiled paths + massive speed improvements via strength reduction, constant folding, and O(1) frame-based argument passing.
...
https://central.sonatype.com/artifact/com.github.gbenroscience/parser-ng/1.1.5
...
```bash
java -jar parser-ng-1.1.5.jar "sin(x) + cos(x)"
java -jar parser-ng-1.1.5.jar "eigvalues(R=@(5,5)(...))"
java -jar parser-ng-1.1.5.jar help
java -jar parser-ng-1.1.5.jar -i          # interactive mode
```
...
- [LATEST.md](LATEST.md) — what’s new in 1.1.5
- Javadoc: https://javadoc.io/doc/com.github.gbenroscience/parser-ng/1.1.5
...
**ParserNG 1.1.5** — faster than the competition, stronger on matrices, and now with real Turbo Scalar + Turbo Matrix compiled power.
