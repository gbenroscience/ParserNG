...
**ParserNG 1.1.4** is a **blazing-fast**, nigh zero allocation(memory wise), **pure Java**, **zero-native-dependencies** math expression parser and evaluator.
...
![Latest Version](https://img.shields.io/badge/version-1.1.4-success)

> **1.1.4** introduces **Turbo Scalar** and **Turbo Matrix** compiled paths + massive speed improvements via strength reduction, constant folding, and O(1) frame-based argument passing.
...
https://central.sonatype.com/artifact/com.github.gbenroscience/parser-ng/1.1.4
...
```bash
java -jar parser-ng-1.1.4.jar "sin(x) + cos(x)"
java -jar parser-ng-1.1.4.jar "eigvalues(R=@(5,5)(...))"
java -jar parser-ng-1.1.4.jar help
java -jar parser-ng-1.1.4.jar -i          # interactive mode
```
...
- [LATEST.md](LATEST.md) — what’s new in 1.1.4
- Javadoc: https://javadoc.io/doc/com.github.gbenroscience/parser-ng/1.1.4
...
**ParserNG 1.1.4** — faster than the competition, stronger on matrices, and now with real Turbo Scalar + Turbo Matrix compiled power.
