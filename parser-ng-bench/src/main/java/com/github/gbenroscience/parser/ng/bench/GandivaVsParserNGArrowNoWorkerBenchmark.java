...
@Fork(value = 2)
public class GandivaVsParserNGArrowNoWorkerBenchmark {
    ...
    public void setupTrial() throws Exception {
        ...
        try {
            ...
            System.getLogger(GandivaVsParserNGArrowNoWorkerBenchmark.class.getName()).log(System.Logger.Level.ERROR, (String) null, ex);
    ...
    public static void runAllCorrectnessChecks() throws Exception {
        for (ExpressionDef def : EXPRESSIONS) {
            GandivaVsParserNGArrowNoWorkerBenchmark benchmark = new GandivaVsParserNGArrowNoWorkerBenchmark();
    ...
    public static void main(String[] args) throws Exception {
        ...
        Options opt = new OptionsBuilder()
                .include(GandivaVsParserNGArrowNoWorkerBenchmark.class.getSimpleName())
