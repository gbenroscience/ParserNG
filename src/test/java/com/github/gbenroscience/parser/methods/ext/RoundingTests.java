...
public class RoundingTests {
    ...
    void roundingDigits() {
        ...
        Assertions.assertEquals("100.0", me.solve());
        me = new MathExpression("roundDigitsN(2, 125.35)");
        Assertions.assertEquals("130.0", me.solve());
        me = new MathExpression("roundDigitsN(2, -125.35)");
        Assertions.assertEquals("-130.0", me.solve());
        me = new MathExpression("roundDigitsN(2, -124.35)");
        Assertions.assertEquals("-120.0", me.solve());
        me = new MathExpression("roundDigitsN(3, 125.35)");
        Assertions.assertEquals("125.0", me.solve());
    ...
    void roundingAsExpected() {
        ...
        for (String s : new String[]{"", "-", "--"}) {
            ...
            Assertions.assertEquals(Double.parseDouble(r + "13"), Double.parseDouble(me.solve()));
        }
    }
    ...
    void roundNingAsExpected() {
        ...
        for (String s : new String[]{"", "-", "--"}) {
            ...
            Assertions.assertEquals(Double.parseDouble(r + "13.00"), Double.parseDouble(me.solve()));
        }
    ...
    void roundXingAsExpected() {
        ...
        for (String s : new String[]{"", "-", "--"}) {
            ...
            Assertions.assertEquals(Double.parseDouble(r + "1.1"), Double.parseDouble(me.solve()));
            me = new MathExpression("roundX(2," + s + "1.9)");
            Assertions.assertEquals(Double.parseDouble(r + "1.9"), Double.parseDouble(me.solve()));
            ...
            Assertions.assertEquals(Double.parseDouble(r + "13.0000"), Double.parseDouble(me.solve()));
        }
    }
    ...
    void roundAsExpectedFunctions() {
        ...
        Assertions.assertEquals(Double.parseDouble("-1"), Double.parseDouble(me.solve()));
