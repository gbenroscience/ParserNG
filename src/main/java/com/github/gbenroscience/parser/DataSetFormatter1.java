 ...
 */
public class DataSetFormatter1 {
...
/*
    sum((sin(3)),(cos(3)),(ln(345)),sort(3,-4,5,-6,13,2,4,5,(sum(3,4,5,6,9,12,23)),( sum(3,4,8,9,2000))),12000,( mode(3,2,2,1)),( mode(1,5,7,7,1,1,7)))
    sum(sin(3),cos(3),ln(345),sort(3,-4,5,-6,13,2,4,5,sum(3,4,5,6,9,12,23), sum(3,4,8,9,2000)),12000, mode(3,2,2,1), mode(1,5,7,7,1,1,7))
    */
...
// System.out.printf("lastIndexOfCursor = %d, indexOfComma = %d\n ",lastIndexCursor,indexOfComma);
     ...
     * sort( (2),(sin(3)),(4)....)
     */
    private void scanCommaSeparatedData(String myStr) {
    ...
    public static void main(String args[]) {
        ...
        DataSetFormatter1 f = new DataSetFormatter1(fn);
