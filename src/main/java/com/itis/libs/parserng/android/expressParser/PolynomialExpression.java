...
/**
 * Solves the Polynomial with normal double
 * precision....about 16d.p.
 */
public static final int DOUBLE_PRECISION = 1;
/**
 * Solves the Polynomial with BigDecimal
 * precision....about 16d.p.
 */
public static final int BIGDECIMAL_PRECISION = 2;

/**
 * Used to select what mode to operate objects
 * of this class...whether DOUBLE_PRECISION
 * or BIGDECIMAL_PRECISION.
 */
private int precision=DOUBLE_PRECISION;

/**
 *
 * @param expression A valid polynomial expression,
 * having powers of the variable as only non-negative integers.
 */ 
 ...
 * If set to any value other than 1 (DOUBLE_PRECISION)
 * or 2 (BIGDECIMAL_PRECISION), it defaults to DOUBLE_PRECISION
 */
 ...
 * The precision returned here is that of double numbers, namely about 16d.p
 */
