 ...
 * or the full name of the function which is a combination of
 * the name of its dependent variable and its independent variables
 * enclosed in circular parentheses.
 * e.g in y = x^3, either y or y(x) may be supplied.
 ...
 *
 * @param fName The name of the dependent variable of the function.
 * @return the Function object that has the name supplied
 * if it exists.
 * If no such Function object exists, then it returns null.
 */
...
/**
 * Attempts to retrieve a Function
 * object from a FunctionManager based on its name.
 * @param functionName The name of the Function object.
 * @return the Function object that has that name or
...
public static Function lookUp( String functionName ){
     ...
     * @param expression The expression that creates the
     * Function to add.
     * The form is:F=@(x,y,z,...)mathexpr.
     * e.g y=@(x)3x-x^2;
     * Functions take precedence over variables..
     *                   so if a function called sin_func is created and there
     *                   exists a variable with that name, the system discards that variable
     */
...
update();
     ...
     * {@link FunctionManager#FUNCTIONS} {@link Map}.
     * @param functions A {@link Map} of {@link Function} objects.
     * @param clearFirst If true, then the {@link FunctionManager#FUNCTIONS} is cleared first before
...
/**
 *
 * @return the number of anonymous functions in
 * the FunctionManager.
 */
...
synchronized (FUNCTIONS) {
    ...
    /**
     *
     * @return An {@link ArrayList} of all non-anonymous
     * functions.
     */
    ...
    /**
     * Saves stored functions and:
     * updates the client UIs that use this manager.
     */
    ...
    /**
     * Registers the parameters of all registered functions
     * as Variables on the Variable Registry.
     */
