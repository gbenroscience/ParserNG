 ...
 * as input and convert it into its
 * polynomial form.
 *
 *
...
public class FunctionExpander {
     ...
     * It determines how accurately the
     * polynomial will describe the function.
     *
...
/**
 * Uses the precision of double
 * numbers to expand the function.
 * This is about 16 places of decimal.
 */
   public static final int DOUBLE_PRECISION = 1;
/**
 * Uses the precision of double
 * numbers to expand the function.
 * This is about 33 places of decimal.
 * <br/><b color='red'>CAUTION!!!!</b><br/>
 * This should be used only if the
 * algorithm of the parser that expands the
 ...
 */
   ...
   /**
    *
    * Objects of this class will employ this constructor
    * in creating the polynomial of best fit  for the input function
    * between the given boundary values of x.
    * The degree parameter is the highest power of the polynomial
    * formed.
    *
    * Creates a new object of this class and initializes it with the
 ...
 * the function whose polynomial expansion is to be deduced and the limits
 * of expansion.
 * For example:
 * function,2,4,20....means expand the function between horizontal
 * coordinates 2 and 3 as a polynomial up to degree 20..
 * Direct examples would be:
 * sin(x+1),3,4,20
 * cos(sinh(x-2/tan9x)),4,4.32,32 and so on.
 *
 * F(x)=var x=3;3x;
 * poly(F,4,4.32,32)
 *
 ...
 * @param precisionMode The precision mode to employ in expanding the Function.
 ...
 * functions generated from above.
 * Its operations are trustworthy if the powers
 * of the polynomial variable never fall below zero.
 * i.e it is valid for n>=0
 */
