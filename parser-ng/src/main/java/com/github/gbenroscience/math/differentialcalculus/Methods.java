...
public class Methods {
    ...
    /**
     *
     * @param name The name of the token we wish to verify as an inbuilt method
    ...
    /**
     *
     * @param method The method name..e.g sin, cos, tan e.t.c.
     * @param var The name of the Differentiable.
